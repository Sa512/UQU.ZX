...
psql -d mz_test -v ON_ERROR_STOP=1 -q -f supabase/tests/harness.sql $(ls supabase/migrations/*.sql | sed 's/^/-f /') -f supabase/tests/cloud_test.sql -f supabase/tests/sections_test.sql | grep -E "PASSED|ERROR"
